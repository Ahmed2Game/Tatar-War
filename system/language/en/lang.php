...
global $gameConfig;
    ...
    define("item_curprod_27", "You may currently occupy");
    define("item_nextprod_27", "You may occupy in level");
    define("item_unit_27", "artefact");
    define("item_desc_27", "The riches of your empire are kept in the treasury. The treasury has room for one treasure. After you have captured an artefact it takes 24 hours to be effective");
...
Therefore his strength in attacking is rather low and also his speed is, compared to other cavalry units, below the average. The training takes very long and is rather expensive.' );
	...
	define("report_result_text0", "Your troops die from hunger");
    ...
    define("report_action_text5", "You've got an attack on reinforcements in");
    define("report_action_text6", "Your troops die of hunger in");
	...
	define("payments_fortumo_period", "Immediately");
    define("payments_fortumo_description", "Payment by messages through your mobile phone fast but is expensive");
	...
	define("payments_xsolla_period", "Immediately");
    define("payments_xsolla_description", "More than 200 payment methods across the world of the most famous payment methods (Visa - MasterCard - PayPal - Skirll - Mobile SMS - Filspay)");
...
Note: This is a message and does not require an automatic response.' );
	define( 'register_player_txt_notless3', '(Must be at least 5 characters)' );
	...
	define( 'register_player_txt_notless6', '(Must be at least 6 characters)' );
	define("register_player_txt_invalidbas", "(For there must be one character English (a-z))");
...
<a href="%s">%s</a>' );
	...
	define("messages_p_people", "You can not send messages and number of your population less than 300");
    define("messages_p_block", "This player has to ignore your account");
	...
	define("v2v_p_playerwas_holiday", "This player in the holiday period");
	define( 'v2v_p_playerwas_blocked', 'Reserve this player from playing' );
	define("v2v_p_playerwas_youblocked", "Your account blocked");
	define( 'v2v_p_playerwas_inprotectedperiod', 'This player is still under the protection period' );
	define("v2v_p_playerwas_youinprotectedperiod", "You is still under the protection period");
    define("v2v_p_playerwas_week", "This player you much weaker population of less than 10% of your population");
    define("v2v_p_playerwas_strong", "This player is much stronger than you inhabitants of less than 10% of the population");
    ...
    define("v2v_p_cantattac", "You can not send more than 50 attack from the same village at a time");
    define("v2v_p_isAgent", "Agent can not send reinforcements");
	...
	define("text_delete_lang", "delete");
	define( 'text_newvill_lang', 'Well done you have to build a new village' );
	define("LANGUI_TRANS_T6", "Player does not exist");
    define('LANGUI_TRANS_T7', 'The password is incorrect');
    define('LANGUI_TRANS_T8', 'Number of gold is not valid');
    define('LANGUI_TRANS_T9', 'You can not move Free Gold');
    global $serv;
    if($serv != NULL)
    {
        define('LANGUI_TRANS_T10', 'The number of your population less than '.$gameConfig['settings']['pepole']);
    }
    define('LANGUI_TRANS_T12', 'Gold has been successfully converted');
    define('LANGUI_ADCP_E1', 'Remember been successfully');
    define("LANGUI_PROFILE_e1", "It must not be less than the new password 6 characters");
    define("LANGUI_PROFILE_e2", "Two words new password is not identical");
    define("LANGUI_PROFILE_e3", "Old password is incorrect");
    define("LANGUI_PROFILE_e4", "Password was successfully changed");
    define("LANGUI_PROFILE_e5", "Old mail is incorrect");
    define("LANGUI_PROFILE_e6", "New mail is not valid");
    define("LANGUI_PROFILE_e7", "Email has been changed successfully");
    define("LANGUI_PROFILE_e8", "Must be at least name of the village for 5 characters and no more than 25 characters");
    define("LANGUI_PROFILE_e9", "Data has been changed successfully");
    define("LANGUI_PROFILE_e10", "Date of birth should not be left blank");
    define("LANGUI_PROFILE_e11", "You can not activate the deletion when you have Artefacts");
    define('LANGUI_PAIN_reason', 'Foreclosed multiple memberships and send to the membership on the same IP resources');
    define('LANGUI_PAIN_reason2', 'Foreclosed multiple memberships and send missionaries to the membership on the same IP');
    define('LANGUI_FARM_T9', 'Please enter the village information form properly.');
    define('LANGUI_FARM_T10', 'You can not post this village.');
    define('LANGUI_FARM_T11', 'Do not you change the number of soldier checking element.');
    define('LANGUI_FARM_T12', 'Please select the number of troops.');
    define('LANGUI_FARM_T13', 'You can not add more farms.');
    define('LANGUI_FARM_T14', 'It has been added to farm successfully.');
    define('LANGUI_FARM_T18', 'Enter the coordinates correctly.');
?>
