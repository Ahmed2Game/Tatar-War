...
define("LANGUI_HLP_T77", "The arrival of army reinforcements immediately");
define("LANGUI_HLP_T78", "The arrival of all reinforcements coming to you immediately, except if this reinforcement contains slings forces or Mahtmat or kings or this village legend");
define("LANGUI_HLP_T79", "Purchase resources");
define("LANGUI_HLP_T80", "You can now buy resources by gold you can buy a certain number of each supplier in exchange for gold coins and you can specify the number of gold purchase to be done to be calculated in the number that are buy one gold");
define("LANGUI_HLP_T81", "Statistics developed villages");
define("LANGUI_HLP_T82", "List of farms");
define("LANGUI_HLP_T83", "Find villages wheat");
define("LANGUI_HLP_T84", "Send traders more than once");
?>
