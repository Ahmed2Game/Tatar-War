<?php
  ...
  define("item_curprod_27", "تستطيع احتلال حاليا");
  define("item_nextprod_27", "تستطيع احتلال في المستوى");
  define("item_unit_27", "تحفة");
  ...
  define("report_result_text0", "قواتك تموت من الجوع");
  ...
  define("report_action_text5", "لقد حصل هجوم على التعزيزات في");
  define("report_action_text6", "قواتك تموت جوعا في");
  ...
  define("payments_cashu_description", "الدفع عبر CashU سهل وسريع قم باختيار الباقة ثم تسجيل الدخول الى حسابك واتم الدفع وانتظر حتى تعود الى موقعنا");
  define("payments_fortumo_period", "فورا");
  define("payments_paypal_period", "فورا");
  define("payments_paypal_description", "الدفع عبر PayPal سهل وسريع قم باختيار الباقة ثم تسجيل الدخول الى حسابك واتم الدفع وانتظر حتى تعود الى موقعنا");
  define("payments_fortumo_description", "الدفع بواسطة الرسائل من خلال هاتفك المحمول سريع ولكن غالى الثمن");
  define("payments_G2A_period", "فورا");
  define("payments_G2A_description", "اكثر من 50 طريقة دفع عبر العالم من اشهر طرق الدفع (Visa - MasterCard - PayPal - Skirll - Mobile SMS - OneCard - CashU)");
  define("payments_onecard_period", "فورا");
  define("payments_onecard_description", "الشراء عبر OneCard سهل وسريع قم باختيار الباقة ثم تسجيل الدخول الى حسابك واتم الدفع وانتظر حتى تعود الى موقعنا");
  define("artefacts_tribe_villages", "قرى التحف");
  ...
  define("forget_password_body", "مرحباً <b>%s</b><br/><br/>كلمة السر الجديدة:<br/>\الرجاء أجعلها قوية<br/><br/>----------------------------<br/>الإسم: %s<br/>----------------------------<br/><br/>انقر على هذا الرابط لتفعيل كلمة السر الجديدة:<br/><br/><a href=\"%s\">%s</a><br/><br/>اذا كنت لم تطلب كلمة السر الجديدة، يمكنك ان<br/>تتجاهل هذا الرسالة.");
  ...
  define("login_result_msg_block", "تم حظر حسابك حظر نهائي");
  define("login_result_msg_blocked", "تفاصيل حظر حسابك");
  define("login_result_msg_blockedtime", "وقت انتهاء مدة الحظر");
  define("login_result_msg_blockedreason", "سبب الحظر");
  define("login_result_msg_blockedsend", "اذا كان هذا تم عن طريق الخطا او هناك تظلم يمكنك مراسلة الدعم");
  ...
  define("login_result_msg_bainwrongpwd", "تم استهلاك 10 محاولات المسموح بهم فضلا حاول مره اخرى بعد 15 دقيقة");
  ...
  define("register_player_txt_notless3", "(يجب ان لا يقل عن 5 حروف)");
  ...
  define("register_player_txt_notless6", "(يجب أن لا يقل عن 6 حروف)");
  define("register_player_txt_invalidbas", "(لابد من وجود حرف واحد انجليزي (a-z))");
  ...
  define("register_player_txt_captchae", "(كود التاكد فارغ)");
  ...
  define("messages_p_notfriend", "هذا اللاعب ليس ضمن الاصدقاء");
  ...
  define("messages_p_notfound", "هذه الرساله ليست موجودة");
  define("messages_p_notexists", "لا يوجد هذا الأسم");
  define("messages_p_people", "لا يمكنك ارسال رسائل وعدد سكانك اقل من 300");
  define("messages_p_block", "هذا اللاعب قام بتجاهلك");
  ...
  define("v2v_p_playerwas_holiday", "هذا اللاعب في فترة الاجازة");
  ...
  define("v2v_p_playerwas_week", "هذا اللاعب اضعف منك بكثير سكانة اقل من 10 % من سكانك");
  define("v2v_p_playerwas_strong", "هذا اللاعب اقوى منك بكثير سكانك اقل من 10 % من سكانه");
  define("v2v_p_playerwas_inyouralliance", "هذا اللاعب في نفس التحالف");
  define("v2v_p_playerwas_inpeacealliance", " هذا اللاعب في تحالف عدم اعتداء مع تحالفكم");
  ...
  define("v2v_p_cantattac", "لا يمكنك ارسال اكثر من 50 هجمة من نفس القريه في وقت واحد");
  define("v2v_p_isAgent", "الوكيل لا يمكنة ارسال مساندة");
  ...
  define('LANGUI_TRANS_T9', 'لا يمكن تحويل الذهب المجانى');
  global $serv;
  if($serv != NULL)
  {
      define('LANGUI_TRANS_T10', 'عدد سكانك اقل من '.$gameConfig['settings']['pepole']);
  }
  define('LANGUI_TRANS_T12', 'تم تحويل الذهب بنجاح');
  define('LANGUI_ADCP_E1', 'تم حفظ البيانات بنجاح');
  define("LANGUI_PROFILE_e1", "لابد ان لا تقل كلمة السر الجديدة عن 6 احرف");
  define("LANGUI_PROFILE_e2", "كلمتان السر الجديدة غير متطابقة");
  define("LANGUI_PROFILE_e3", "كلمة السر القديمة غير صحيحة");
  define("LANGUI_PROFILE_e4", "تم تغيير كلمة السر بنجاح");
  define("LANGUI_PROFILE_e5", "البريد القديم غير صحيح");
  define("LANGUI_PROFILE_e6", "البريد الجديد ليس صالحا");
  define("LANGUI_PROFILE_e7", "تم تغيير البريد بنجاح");
  define("LANGUI_PROFILE_e8", "يجب ان لا يقل اسم القرية عن 5 حروف وان لا يزيد عن 25 حرف");
  define("LANGUI_PROFILE_e9", "تم تغيير البيانات بنجاح");
  define("LANGUI_PROFILE_e10", "لا يجب ترك تاريخ الميلاد فارغ");
  define("LANGUI_PROFILE_e11", "لا يمكن تفعيل حذف العضوية وانت تمتلك تحفة");
  define('LANGUI_PAIN_reason', 'ممنوع تعدد العضويات وارسال موارد لعضوية على نفس الايبي');
  define('LANGUI_PAIN_reason2', 'ممنوع تعدد العضويات وارسال ارساليات لعضوية على نفس الايبي');
  define('LANGUI_SUPPORT_E1', 'الدعم الفني');
  define('LANGUI_SUPPORT_E2', 'الدعم الفني هو شخص لديه خبرة كبيرة في اللعبة , ووظيفته هي الرد على استفساراتكم وحل جميع مشاكلكم وايجاد المخالفات وحظر الخارجين عن قوانين اللعبة , يجب على كل شخص وضع عنوان مناسب لرسالته ونود تنبيهكم بأنه لن يتم الرد على الرسائل التي بدون عنوان , لمراسلة الدعم الفني <a href="msg?uid=2">اضغط هنا</a>');
  define('LANGUI_SUPPORT_E3', 'ادارة اللعبة');
  define('LANGUI_SUPPORT_E4', 'ادارة اللعبة يأتي دورها في الأمور التي لا يستطيع الدعم الفني حلها , مثل مشاكل شحن الذهب او الشكاوي ضد الدعم الفني نفسه , يجب على كل شخص وضع عنوان مناسب لرسالته ونود تنبيهكم بأنه لن يتم الرد على الرسائل التي بدون عنوان , لمراسلة ادارة اللعبة <a href="msg?uid=1">اضغط هنا</a>');
  define('LANGUI_FARM_T9', 'يرجى ادخال معلومات القرية بشكلة صحيح.');
  define('LANGUI_FARM_T10', 'لا يمكن اضافة هذه القرية.');
  define('LANGUI_FARM_T11', 'لا تقوم بتغيير رقم الجندى من فحص العنصر.');
  define('LANGUI_FARM_T12', 'يرجى اختيار عدد القوات.');
  define('LANGUI_FARM_T13', 'لا يمكنك اضافة المزيد من المزارع.');
  define('LANGUI_FARM_T14', 'تم اضافة المزرعة بنجاح.');
  define('LANGUI_FARM_T18', 'ادخل الاحداثيات بشكل صحيح.');
  define("LANGUI_FE_T1", "تم ارسال الطلب بنجاح");
  define("LANGUI_FE_T2", "لا يمكن ارسال اكثر من ٥ طلبات في اليوم");
  define("LANGUI_FE_T3", "يوجد طلب صداقة بالفعل");
  define("LANGUI_FE_T4", "انتم اصدقاء بالفعل");
  define("LANGUI_FE_T5", "لا يمكن ارسال طلب صداقة لنفسك");
?>
