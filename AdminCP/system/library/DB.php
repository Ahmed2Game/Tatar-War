...
class DB
{
  ...
  * @return string
  */
 public static function count($query = null, $field = array())
 {
  ...
  * @return string
  */
 public static function get_field($query = null, $field = array())
 {
  ...
  * @return array
  */
 public static function get_row($query = null, $field = array())
 {
  ...
  */
 public static function get_all($query = null, $field = array(), $key = null, $value = null)
 {
  $rows = array();
  ...
  */
 public static function set_fetch_mode($fetch_mode = PDO::FETCH_ASSOC)
 {
  ...
  * @param array $data the parameter must be an associative array (name=>value)
  */
 public static function update($table, $data, $where, $field = null)
 {
  if (count($data)) {
   $fields = "";
   foreach ($data as $name => $value) {
  ...
  */
 public static function get_executed_query()
 {
  return self::$nquery;
 }
  ...
  */
 public static function setup($string, $username, $password, $pdo_options = array())
 {
  try {
